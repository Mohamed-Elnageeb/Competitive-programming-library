...
// int cpp20[200001],cpp17[200001],cpp14[200001];
// //mt19937 mt(0);
// main()
// {
...
// 		cpp20[i]=1LL*172933ul*i%(int)(1e9);
// 		cpp17[i]=1LL*107897ul*i%(int)(1e9);
// 		cpp14[i]=1LL*62233ul*i%(int)(1e9);
// 	}
// 	#define a cpp14
...
// 				cout<<a[x]<<' '<<a[x]+1<<endl;
// 		}
// 		else cout<<2<<endl<<a[1]<<' '<<a[1]+1<<endl<<a[2]<<' '<<a[2]+1<<endl;
// 	}
// }